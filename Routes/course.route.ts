...
import { addAnswer, addQuestion, addReplyToReview, addReview, deleteCourse, editCourse, generateVedioUrl, getAllCourse, getAllCourseAdmin, getCourseByUSer, getSingleCourse, uploadCourse } from "../controller/course.controller";
